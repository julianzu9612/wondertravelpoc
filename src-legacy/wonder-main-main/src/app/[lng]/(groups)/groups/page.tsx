...
import Impact from '../corporate/_components/impact/Impact';
...
import AddOns from './_components/addOns/AddOn';
import { useTranslation } from '@i18n-server';

const GroupsPage = async ({ params: { lng } }: { params: { lng: string } }) => {
  const { t } = await useTranslation(lng, 'groups');
